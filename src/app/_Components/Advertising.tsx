  ...
  return (
    <section className="bg-white px-6 py-12 md:py-20">
      ...
      <div className="max-w-5xl mx-auto text-center mb-16">
        <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4 font-raleway">
          Pay-Per-Click{" "}
          <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#5598F7] to-[#5D3DAF]">
            Advertising
          </span>
        </h2>
        <p className="text-gray-600 text-base md:text-lg font-raleway max-w-3xl mx-auto">
      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center md:items-start gap-12 " data-aos="zoom-in-down">
